...
uprs = ['METEC01','METENSB','METENFL','METENGC','METENHI','METENLG','METENPA','METENTF','METENCE','METENML']
uprs_meter = ['METER01']
...
def get_consumos_salida_raw(uprs, up):
    ...
    fecha_fin = (fecha_actual + timedelta(days=14)).strftime('%Y-%m-%d')
...
if __name__ == '__main__':
    get_consumos_salida_raw(uprs, 1)  
